...
cd /opt/hadoop/hadoop-2.10.1/share/hadoop/mapreduce/
ls
//.....jar ...
...
SPARKLA_HOME/binHADOOP_CONF_HOME=$HADOOP_HOME/etc/hadoop
export SPARK_HOME=/opt/model/spark-3.0.0-preview2-bin-hadoop2.7
export SPARK_MASTER_IP=192.168.65.22
//6.重新加载配置文件
source /etc/profile
//7.将文件所有者改为hadoop用户
chown -R xin0127:xin0127 /opt/model/spark-3.0.0-preview2-bin-hadoop2.7
//8.启动spark
su hadoop
