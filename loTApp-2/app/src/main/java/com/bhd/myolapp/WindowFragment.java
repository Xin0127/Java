...
public class WindowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        timeSelectopenwindow = view.findViewById(R.id.time_select_openwindow);
        timeSelectclosewindow = view.findViewById(R.id.time_select_closewindow);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //定时开
        timeSelectopenwindow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar = Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(), 5, txtTimeopenwindow, calendar);
            }
        });
        //定时关
        timeSelectclosewindow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar = Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(), 6, txtTimeclosewindow, calendar);
            }
        });
    }
