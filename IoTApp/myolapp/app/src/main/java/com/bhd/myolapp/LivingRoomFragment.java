...
public class LivingRoomFragment extends Fragment {
    ...
    private Button timeSelectLiving;
    private TextView txtTimeLiving;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        timeSelectLiving = view.findViewById(R.id.time_select_living);
        txtTimeLiving= view.findViewById(R.id.txt_time_living);
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //定时
        timeSelectLiving.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar= Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(),  4, txtTimeLiving, calendar);
            }
        });
    }
