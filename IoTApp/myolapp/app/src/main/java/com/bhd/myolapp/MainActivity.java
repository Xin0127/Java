    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.living_btn:
                ...
                //替换Fragment
                SwithFragment(fg1,MainActivity.this,R.id.fragment).commit();
                break;
            case R.id.bedroom_btn:
                //替换Fragment
                SwithFragment(fg2,MainActivity.this,R.id.fragment).commit();
                break;
            case R.id.bathroom_btn:
                //替换Fragment
                SwithFragment(fg3,MainActivity.this,R.id.fragment).commit();
                break;
            case R.id.setip_img:
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (msg.endsWith("open")) {
                                ...
                                Toast.makeText(MainActivity.this, "灯已经打开", Toast.LENGTH_SHORT).show();
                            } else {
                                dpxs.setImageResource(R.drawable.dp_dark);
                                Toast.makeText(MainActivity.this, "灯已经关闭", Toast.LENGTH_SHORT).show();
                            }
