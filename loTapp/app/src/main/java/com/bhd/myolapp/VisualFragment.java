...
public class VisualFragment extends Fragment {
    ...
    private Button btnOpenVisual;
    private Button btnCloseVisual;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        btnOpenVisual = view.findViewById(R.id.btn_open_visual);
        btnCloseVisual = view.findViewById(R.id.btn_close_visual);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开门
        btnOpenVisual.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //关门
        btnCloseVisual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            public void run() {
                ...
                try {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                       @Override
                        public void run() {
                            if ("visual_open".equals(msg)) {
                                Toast.makeText(getActivity().getApplicationContext(), "可视对讲已开启", Toast.LENGTH_SHORT).show();
                            } if ("visual_close".equals(msg)) {
                               Toast.makeText(getActivity().getApplicationContext(), "可视对讲已关闭", Toast.LENGTH_SHORT).show();
