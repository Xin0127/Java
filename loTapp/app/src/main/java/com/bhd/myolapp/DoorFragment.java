...
public class DoorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        View view = inflater.inflate(R.layout.door_fragment, null);
                       ...
                       @Override
                        public void run() {
                            if ("door_open".equals(msg)) {
                                //doorDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "门已打开", Toast.LENGTH_SHORT).show();
                            } if ("door_close".equals(msg)) {
                               //doorDpxs.setImageResource(R.drawable.dp_light);
                               Toast.makeText(getActivity().getApplicationContext(), "门已关闭", Toast.LENGTH_SHORT).show();
                           }if ("确认密码".equals(msg)) {
                               if("1234567890".equals(editTextPassword.getText().toString())) {
                                   Toast.makeText(getActivity().getApplicationContext(), "密码正确", Toast.LENGTH_SHORT).show();
                               }else{
