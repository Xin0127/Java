...
public class HeaterFragment extends Fragment{
    ...
    private Button btnWashingHeater;
    private Button btnShowerHeater;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        btnWashingHeater = view.findViewById(R.id.btn_heater_washing);
        btnShowerHeater = view.findViewById(R.id.btn_heater_shower);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //洗衣模式
        btnWashingHeater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        //沐浴模式
        btnShowerHeater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                    socket = new Socket(ip,port);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if("cold_mood".equals(msg)||"shower_mood".equals(msg)||"washing_mood".equals(msg)){
